...
report={'url':BASE+'index.html?ideas=restaurante-tienda','checked_at':time.strftime('%Y-%m-%dT%H:%M:%SZ',time.gmtime()),'pairs':[],'provider_confirmation_required':False}
with sync_playwright() as pw:
    ...
    try:
        visit('index.html?ideas=restaurante-tienda','#proposal-catalogue')
