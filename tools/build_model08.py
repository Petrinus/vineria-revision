"""Independent model 08. Local files only: no network, secrets or account access.
Writes site/entwuerfe/v08 and adds one card to the existing public selector.
"""
...
SHOP='''<section class="collage-hero shop-hero wrap"><div class="bottle-stack" aria-label="Weine aus unserem Sortiment"><img src="../../../assets/products/bujanda-blanco.webp" alt="Viña Bujanda Viura"><img src="../../../assets/products/vanidade.webp" alt="Vanidade Albariño"><img src="../../../assets/products/egiarte-crianza.webp" alt="Egiarte Crianza"></div><div class="hero-copy"><p class="eyebrow">VINERIA DEL ESTE · TIENDA<br>PRODUCTOS ESPAÑOLES</p><h1>Für den Tisch.<br>Für zu Hause.</h1><p>Die Weine, über die wir gern reden. Die kleinen Dosen, die man gemeinsam öffnet. Unsere Auswahl für Euren nächsten Abend.</p><div class="hero-actions"><a class="btn" href="#sortiment">Auswahl entdecken ↓</a><a class="btn outline" href="../index.html">Zum Restaurant ↗</a></div><span class="handnote">Ein kleines Stück Spanien.</span></div><aside class="shop-slip"><div class="slip-paper"><p class="eyebrow">UNSERE AUSWAHL</p><h2>Mitbringen.<br>Aufmachen.<br>Zusammen.</h2><p>Weine, Konserven und spanische Spezialitäten. Flasche oder Karton: Ihr habt die Wahl.</p><div class="receipt-tag">ABHOLEN IN DER VINERIA<br>VERSAND IN DEUTSCHLAND</div><p>Sortiment und Preise sind Beispiele. Noch kein Verkauf.</p></div></aside></section>'''
...
def add_card(file):
 s=parse(file.read_text());page=file.relative_to(SITE).as_posix();cards=s.select('[data-proposal]');assert cards,'Existing selector missing'
